...
{
	var C_Copyright = "Free, 2020. All rights reserved";
	 ...
	 * Domain types
	 */
	var C_CONNECTION_LOCAL 		= 0; // host and dataserver are the same: data.test.com
	var C_CONNECTION_SUB   		= 1; // host and dataserver are on the same subdomain: we can use direct script access by modifying 'document.domain'
	var C_CONNECTION_PCLIENT 	= 2; // host and dataserver are on differing domains: . A proxy client is used
	...
	var C_SERVERS_COOKIE		= "StreamUsedServers";
